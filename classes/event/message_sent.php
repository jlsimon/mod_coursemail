...
/**
 * Event fired when a message that starts a conversation is sent.
 *
...
class message_sent extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventmessagesent', 'coursemail');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' sent the message with id '{$this->objectid}' " .
