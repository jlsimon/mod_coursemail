...
/**
 * Event fired when a conversation becomes active (its first message is sent).
 *
...
class conversation_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventconversationcreated', 'coursemail');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' created the conversation with id '{$this->objectid}' " .
