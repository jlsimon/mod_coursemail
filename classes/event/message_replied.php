...
/**
 * Event fired when a reply is sent within an existing conversation.
 *
 ...
 *     - int conversationid: the conversation the reply belongs to.
 * }
 */
class message_replied extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventmessagereplied', 'coursemail');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' replied with the message with id '{$this->objectid}' " .
